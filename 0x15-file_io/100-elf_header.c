...
* @e_ident: This refers to a pointer to an array
...
* @e_ident: This refers to s pointer to an array containing the ELF class.
*/
...
* @e_ident: This refers to a pointer to an array containing the ELF version.
*/
...
* @e_type: This refers to an ELF type.
...
* @e_entry: This refers to the address of the ELF entry point.
* @e_ident: This is the memory address (pointer) to
...
* @elf: This is the  file descriptor for the ELF file.
*
...
/**
* main - This function displays the information contained inside the
* ELF header at the start of an ELF file.
* @argc: This is the number of arguments that are supplied to the program.
* @argv: This describes an array of pointers to the arguments.
*
* Return: 0 on success.
*
